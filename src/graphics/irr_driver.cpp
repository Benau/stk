...
begin:
            ...
            std::string(UserConfigParams::m_render_driver) == "directx12")
        {
            ...
            GE::getGEConfig()->m_max_pointlights = UserConfigParams::m_max_pointlights;
            if (UserConfigParams::m_point_shadow_limit > UserConfigParams::m_max_pointlights)
                UserConfigParams::m_point_shadow_limit = UserConfigParams::m_max_pointlights;
            GE::getGEConfig()->m_point_shadow_limit = UserConfigParams::m_point_shadow_limit;
#endif
        }
        else
        {
